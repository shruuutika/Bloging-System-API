...
exports.login = async (req,res)=>{
    try {
        const userExists = await User.findOne({email:req.body.email})
        if(userExists) return res.json({errors:true,message:"email or password invalid"})

        const validPassword = await bcrypt.compare(req.body.password,uerExists.password)
